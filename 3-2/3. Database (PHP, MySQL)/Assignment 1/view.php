<?php
    ...
    $sql = "select b_title, b_content, b_date,b_hit, b_id, b_image from board_free where b_no = '$bNo'";
	$result = $db->query($sql);
...
<head>
	<meta charset="utf-8" />
	<title>자유게시판 | Hanbyeol's Library</title>
...
<body>
	<article class="boardArticle">
		...
		<div id="boardView">
            ...
            <div id="boardImage">
			<img src="<?php echo $row['b_image']?>" width = "50%">
			<div class="btnSet">
